...
class SpringDocAuthenticationConfiguration {
  ...
  @Bean
  OpenApiCustomizer springDocAuthCustomizer(InMemoryClientRegistrationRepository clientRegistrationRepository) {
    return openapi -> {
        ...
        if (Objects.equals(
          ...
          openapi.getPaths().addPathItem(
              ...
              new PathItem().get(new Operation()
                  .tags(List.of("UserSessions"))
                  .operationId("startLoginWith%s%s".formatted(
                      registration
                          .getRegistrationId()
                          .substring(0, 1)
                          .toUpperCase(),
      ...
      openapi.getPaths().addPathItem(
          ...
          new PathItem().post(new Operation()
              ...
              .responses(new ApiResponses().addApiResponse(
                  Integer
                      .valueOf(HttpStatus.ACCEPTED.value())
                      .toString(),
