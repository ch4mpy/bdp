...
class MoneyTransferJpaRepositoryTest {
  ...
  void setUp() {
    transfer1 = moneyTransferJpaRepository.save(MoneyTransfer
        .builder()
        .fromIban(Iban.parse("FR76 111222333"))
        .toIban(Iban.parse("FR76 444555666"))
    ...
    transfer2 = moneyTransferJpaRepository.save(MoneyTransfer
        .builder()
        .fromIban(Iban.parse("FR76 123456789"))
        .toIban(Iban.parse("FR76 987654321"))
  ...
  void whenCriteriaOnFromAccount_thenTransfersFiltered() {
    var actual =
        moneyTransferJpaRepository.findAll(MoneyTransferJpaRepository.searchSpec(new MoneyTransferFilteringCriteria(
    ...
    assertThat(actual
        .stream()
        .anyMatch(t -> Objects.equals(Iban.parse("FR76 987654321"), t.getToIban()))).isTrue();
    assertThat(actual
        .stream()
        .anyMatch(t -> Objects.equals(Iban.parse("FR76 444555666"), t.getToIban()))).isTrue();
  }
  ...
  void whenCriteriaOnToAccount_thenTransfersFiltered() {
    ...
    assertThat(actual
        .stream()
        .allMatch(t -> Objects.equals(Iban.parse("FR76 444555666"), t.getToIban()))).isTrue();
    assertThat(actual
        .stream()
