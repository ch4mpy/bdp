...
class MoneyTransferJpaRepositoryTest {
    ...
    void whenCriteriaOnMinAmount_thenTransfersFiltered() {
        ...
        assertThat(actual).hasSize(2);
        assertThat(actual.stream().anyMatch(t -> Objects.equals(2000L, t.getAmount().getDigits()))).isTrue();
        assertThat(actual.stream().anyMatch(t -> Objects.equals(3000L, t.getAmount().getDigits()))).isTrue();
    }
    ...
    void whenCriteriaOnMaxAmount_thenTransfersFiltered() {
        ...
        assertThat(actual).hasSize(2);
        assertThat(actual.stream().anyMatch(t -> Objects.equals(1000L, t.getAmount().getDigits()))).isTrue();
        assertThat(actual.stream().anyMatch(t -> Objects.equals(2000L, t.getAmount().getDigits()))).isTrue();
    }
    ...
    void whenCriteriaOnCurrency_thenTransfersFiltered() {
        ...
        assertThat(actual.stream().allMatch(t -> Objects.equals("XPF", t.getAmount().getCurrencyIso3()))).isTrue();
    }
