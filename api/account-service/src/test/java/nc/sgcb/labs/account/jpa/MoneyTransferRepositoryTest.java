...
class MoneyTransferRepositoryTest {
  ...
  @BeforeEach
  void setUp() {
    transfer1 = moneyTransferJpaRepository.save(MoneyTransfer
        .builder()
        .sourceIban(Iban.of("FR76 111222333"))
        .destinationIban(Iban.of("FR76 444555666"))
        .amount(Amount.builder().digits(1000L).currencyIso3("XPF").build())
        .label("Test transfer 1000 XPF")
        .timestamp(Instant.parse("2025-12-30T12:34:56Z"))
        .build());
    transfer2 = moneyTransferJpaRepository.save(MoneyTransfer
        .builder()
        .sourceIban(Iban.of("FR76 123456789"))
        .destinationIban(Iban.of("FR76 987654321"))
        .amount(Amount.builder().digits(2000L).currencyIso3("EUR").build())
        .label("Test transfer 20 EUR")
        .timestamp(Instant.parse("2026-01-23T12:34:56Z"))
        .build());
    transfer3 = moneyTransferJpaRepository.save(MoneyTransfer
        .builder()
        .sourceIban(Iban.of("FR76 123456789"))
        .destinationIban(Iban.of("FR76 444555666"))
        .amount(Amount.builder().digits(3000L).currencyIso3("KYD").build())
  ...
  void whenCriteriaOnFromAccount_thenTransfersFiltered() {
    var actual =
        moneyTransferJpaRepository.findAll(MoneyTransferRepository.searchSpec(new MoneyTransferFilteringCriteria(
    ...
    assertThat(actual
        .stream()
        .allMatch(t -> Objects.equals(Iban.of("FR76 123456789"), t.getSourceIban()))).isTrue();
    assertThat(actual
        .stream()
        .anyMatch(t -> Objects.equals(Iban.of("FR76 987654321"), t.getDestinationIban()))).isTrue();
    assertThat(actual
        .stream()
        .anyMatch(t -> Objects.equals(Iban.of("FR76 444555666"), t.getDestinationIban()))).isTrue();
  }
  ...
  void whenCriteriaOnToAccount_thenTransfersFiltered() {
    ...
    assertThat(actual
        .stream()
        .allMatch(t -> Objects.equals(Iban.of("FR76 444555666"), t.getDestinationIban()))).isTrue();
    assertThat(actual
        .stream()
        .anyMatch(t -> Objects.equals(Iban.of("FR76 111222333"), t.getSourceIban()))).isTrue();
    assertThat(actual
        .stream()
        .anyMatch(t -> Objects.equals(Iban.of("FR76 123456789"), t.getSourceIban()))).isTrue();
  }
  ...
  void whenCriteriaOnMinAmount_thenTransfersFiltered() {
    ...
    assertThat(actual
        .stream()
        .anyMatch(t -> Objects.equals(2000L, t.getAmount().getDigits()))).isTrue();
    assertThat(actual
        .stream()
        .anyMatch(t -> Objects.equals(3000L, t.getAmount().getDigits()))).isTrue();
  }
  ...
  void whenCriteriaOnMaxAmount_thenTransfersFiltered() {
    ...
    assertThat(actual
        .stream()
        .anyMatch(t -> Objects.equals(1000L, t.getAmount().getDigits()))).isTrue();
    assertThat(actual
        .stream()
        .anyMatch(t -> Objects.equals(2000L, t.getAmount().getDigits()))).isTrue();
  }
  ...
  void whenCriteriaOnCurrency_thenTransfersFiltered() {
    ...
    assertThat(actual
        .stream()
        .allMatch(t -> Objects.equals("XPF", t.getAmount().getCurrencyIso3()))).isTrue();
  }
