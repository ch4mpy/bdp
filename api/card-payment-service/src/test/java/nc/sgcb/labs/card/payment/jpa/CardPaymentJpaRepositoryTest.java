...
class CardPaymentJpaRepositoryTest {
    ...
    @BeforeEach
    void setUp() {
        card1 = cardRepo.save(Card.builder()
                ...
                .build());
        card2 = cardRepo.save(Card.builder()
                .number("2222-2222-2222-2222-2")
                .accountNumber("111-111-222")
                .ceilings(Card.Ceilings.builder().rolling30(500000L).transaction(150000L).build())
                .build());

        payment1 = paymentRepo.save(CardPayment.builder()
                .card(card1)
                .amount(new Amount("XPF", 120000L))
                .destAccountNumber("2222-2222-2222-2222-2")
                .isAccepted(false)
                .timestamp(Instant.parse("2026-01-01T00:01:10Z"))
                .build());
        payment2 = paymentRepo.save(CardPayment.builder()
                .card(card1)
                .amount(new Amount("XPF", 120000L))
                .destAccountNumber("2222-2222-2222-2222-2")
                .isAccepted(false)
                ...
                .build());
        payment3 = paymentRepo.save(CardPayment.builder()
                .card(card2)
                .amount(new Amount("XPF", 120000L))
                .destAccountNumber("2222-2222-2222-2222-2")
